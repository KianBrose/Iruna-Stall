...
<div>
    <form method="post" action="register.php">
        ...
        <div>
            <p><br><b>By registering, you accept our <a href="about.html">Terms of Service</a> and our <a href="about.html">Privacy Policy</a></b></p>
        </div>
        <div class="input-group">
            <br>
            <button type="submit" class="btn btn-default btn-block" name="reg_user">Register</button>
        </div>
        <p>
