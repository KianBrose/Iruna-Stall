...
class IrunaItemController extends Controller
    {
        ...
        {
            return Xtal::groupBy('name')->selectRaw('count(*) as total, name, round(avg(price)) as price')->limit($limitNumber)->get();
        }
        ...
        {
            return Equipment::groupBy('name')->selectRaw('count(*) as total, name, round(avg(price)) as price')->limit($limitNumber)->get();
        }
