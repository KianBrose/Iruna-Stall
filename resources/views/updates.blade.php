...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      <meta charset="utf-8">
      <title> Updates | Iruna Global Stall</title>
      ...
      <meta name='subject' content="Iruna Global Stall Updates">
      ...
      <meta name="apple-mobile-web-app-title" content="Updates | Iruna Global Stall">
      ...
      <meta name="twitter:title" content="Updates | Iruna Global Stall">
                           ...
                           <div class="elementor-column-wrap  elementor-element-populated">
                              <div class="elementor-widget-wrap">
                                 <div class="elementor-element elementor-element-6d1da58 elementor-widget elementor-widget-heading" data-id="6d1da58" data-element_type="widget" data-widget_type="heading.default">
                                    <div class="elementor-widget-container">
                                       <h2 class="elementor-heading-title elementor-size-default">Updates</h2>
                                    </div>
                                 </div>
                                 ...
                                 <div class="elementor-element elementor-element-c9362de elementor-widget elementor-widget-text-editor" data-id="c9362de" data-element_type="widget" data-widget_type="text-editor.default">
                                    <div class="elementor-widget-container">
                                       <div class="elementor-text-editor elementor-clearfix">Hello there! Here are the updates we've released over time:</div>
                                    </div>
                                 </div>
