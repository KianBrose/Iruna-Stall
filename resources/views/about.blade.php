                                    ...
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            ...
                                            <div class="elementor-element elementor-element-010137f elementor-widget elementor-widget-text-editor" data-id="010137f" data-element_type="widget" data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-text-editor elementor-clearfix">
                                                        <p>By signing up to our service, you agree that you are 14 years old or older and let us store information such as email, passwords, usernames and email addresses so we can provide you with the best possible experience.
                                                            <br />
                                                            <br />We reserve the right to delete and modify your information without notice. This would only happen in rare occasions where your account is believed to be related to fraudulent activity.
                                                            <br />
                                                            <br />You are not allowed to create multiple accounts. Anyone having created multiple accounts will have all of the duplicate accounts permanently terminated without notice when discovered.
                                                            <br />
                                                            <br />When posting an item in our “Add Items” page, you are not allowed to enter a “fake price” to make your post appear higher than others on the search rankings. Anyone discovered doing this activity will have their post removed and their account heavily penalized.
                                                            <br />
                                                            <br />You are not allowed to have over 4 posts of the same item (at the exception of equipment) since we have a quantity system set in place, simply put your available quantity all into one item.
                                                            <br />
                                                            <br />If you have been scammed and have proof of fraudulent activity, please send us an email with proof so we can review it and add it to the scammer page.
                                                            <br />
                                                            <br /><span style="text-decoration: underline;"><b>We do not take responsibility for any loss of funds, be it digital currency of real money that may be caused by scammers. </b></span>Inactive accounts will be automatically terminated after 3 months of inactivity. Posts will be automatically removed 1 month after they get posted.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="elementor-element elementor-element-43e0cfa elementor-widget elementor-widget-text-editor" data-id="43e0cfa" data-element_type="widget" data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-text-editor elementor-clearfix">
                                                        <p>We do not sell, distribute or share any information about our users to any 3rd parties. We store information about our users such as email, hashed passwords, ip addresses and usernames so we can provide our service.
                                                            <br />You have access to your data at all times and can delete it all anytime by going to the “Account” page and deleting all of your data.</p>
                                                    </div>
                                                </div>
                                            </div>
