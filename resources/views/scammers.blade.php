        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="width:200px;">
						<img alt="Iruna Stall" src="{{asset('img/bannerIS.jpg')}}" style="width:70%; height:70%">
                </a>
        ...
        <div class="row" >
            <div class="col-md-7 offset-md-3" >
                ...
                <div style="height: auto !important;">
                    ...
                    <hr>
                    <div>
						<p>This page contains information about people that have been found commiting faudulent action within the game. All entries are manually verified by K¹#8224 with enough proof to safely say it's a scam. If you wish to request proof of a scammer, contact K¹#8224 via discord with the ID of the scammer.</p>
