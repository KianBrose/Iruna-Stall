...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      <meta charset="utf-8">
      <title> Report | Iruna Global Stall</title>
      ...
      <meta name='subject' content="Iruna Global Stall Report Page">
      ...
      <meta name="apple-mobile-web-app-title" content="Report | Iruna Global Stall">
      ...
      <meta name="twitter:title" content="Report | Iruna Global Stall">
                           ...
                           <div class="elementor-column-wrap  elementor-element-populated">
                              <div class="elementor-widget-wrap">
                                 <div class="elementor-element elementor-element-6d1da58 elementor-widget elementor-widget-heading" data-id="6d1da58" data-element_type="widget" data-widget_type="heading.default">
                                    <div class="elementor-widget-container">
                                       <h2 class="elementor-heading-title elementor-size-default">Report user</h2>
                                    </div>
                                 </div>
                                 <div class="elementor-element elementor-element-fa9d1bf elementor-widget elementor-widget-text-editor" data-id="fa9d1bf" data-element_type="widget" data-widget_type="text-editor.default">
                                    <div class="elementor-widget-container">
                                       <div class="elementor-text-editor elementor-clearfix">
                                          <p style="color:white;">Welcome to the report page! Select the reason you would like to report user "[username]".</p>
                                       </div>
                                    </div>
                                 </div>
                                       ...
                                       <div class="elementor-text-editor elementor-clearfix">
                                          <form action="/createEquip" method="POST" id="equipform">
                                             ...
                                             <select name="reason" class="form-control2" id="reason">
                                                ...
                                                <option value="1">Contact information doesn't work</option>
                                                <option value="2">User took over 2 days to respond</option>
                                                <option value="3">User refuses to take down items that are not for sale / have already been sold</option>
