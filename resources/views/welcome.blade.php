                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="elementor-image">
                                                    <a href="https://irunastall.com/">
                                                        <img width="2123" height="1000" src="{{asset('img/irunawhite.png')}}" class="attachment-full size-full wp-post-image" alt="" srcset="{{asset('img/irunawhite.png')}}" sizes="(max-width: 2123px) 100vw, 2123px" /> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
