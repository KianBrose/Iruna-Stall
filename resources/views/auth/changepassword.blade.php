          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="https://irunastall.com">Iruna Global Stall</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				<h2><b>Hello!</b><br>Here is your password reset button!</h2>
          ...
          <td valign="middle" class="bg_white" style="padding: 2em 0;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				<p><a href="https://irunastall.com" class="btn btn-black-outline">Back to IrunaStall.com</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
          ...
          <td valign="middle" class="bg_white footer">
            <table>
                ...
                <td valign="middle" width="60%" style="padding-top: 20px; text-align: left;">
                	<h3 class="heading">Join the Iruna discord channel!</h3>
					<p><a href="https://discord.gg/NH75NqA" class="btn btn-primary">Iruna Online Discord</a></p>
                </td>
