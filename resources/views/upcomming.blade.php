...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      <meta charset="utf-8">
      <title> Upcomming Updates | Iruna Global Stall</title>
      ...
      <meta name='subject' content="Iruna Global Stall Upcomming Updates">
      ...
      <meta name="apple-mobile-web-app-title" content="Upcomming Updates | Iruna Global Stall">
      ...
      <meta name="twitter:title" content="Upcomming Updates | Iruna Global Stall">
                           ...
                           <div class="elementor-column-wrap  elementor-element-populated">
                              <div class="elementor-widget-wrap">
                                 <div class="elementor-element elementor-element-6d1da58 elementor-widget elementor-widget-heading" data-id="6d1da58" data-element_type="widget" data-widget_type="heading.default">
                                    <div class="elementor-widget-container">
                                       <h2 class="elementor-heading-title elementor-size-default">Upcomming Updates</h2>
                                    </div>
                                 </div>
                                 ...
                                 <div class="elementor-element elementor-element-c9362de elementor-widget elementor-widget-text-editor" data-id="c9362de" data-element_type="widget" data-widget_type="text-editor.default">
                                    <div class="elementor-widget-container">
                                       <div class="elementor-text-editor elementor-clearfix">We are aware of the issue of some accounts being inactive or having wrong contact links. To combat this, we are working on implementing a report button on user's profiles so that you can notify us if they are inactive or have invalid contact links. <br><br>We are also going to be implementing a feature that automtaically removed item posts 1 month after they have been added to the database to prevent inactive items to stay on the site.</div>
                                    </div>
                                 </div>
